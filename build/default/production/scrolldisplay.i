...
void scrolllog(unsigned char key) {
    ...
    if(key==12 || key==11)
    {
        ...
        else if(out>4000 && key==11)
        {
            ...
            {
                clcd_write(0x01, 0);
                clcd_print((unsigned char*) "Clearing logs", (0x80 + (0)));
                unsigned char k=0;
 ...
 void view_log(unsigned char key)
{
    ...
    if(key==12 && vpos<10)
      ...
      clcd_print( (unsigned char*) eventdata[vpos], (0x80 + (0)));
      clcd_print( (unsigned char*) eventdata[vpos+1], (0xC0 + (0)));
...
{
    static char k=0x05;
     clcd_print((unsigned char*) "Downloading logs ..", (0x80 + (0)));
      for(int j=0; j<10; j++)
    {
        for(int i=0;i<16;i++)
        {
